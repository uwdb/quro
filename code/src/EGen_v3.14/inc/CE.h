...
public:
	...
	CCE( CCESUTInterface *pSUT, CBaseLogger *pLogger, CInputFiles &inputFiles,
				TIdent iConfiguredCustomerCount, TIdent iActiveCustomerCount,
				INT32 iScaleFactor, INT32 iDaysOfInitialTrades,
				UINT32 UniqueId,
				PDriverCETxnSettings pParameterSettings = NULL );
	...
	bool	SetTxnTunables( PDriverCETxnSettings pTxnParamSettings );
