...
public:
	...
	CCETxnMixGenerator( PDriverCETxnSettings pTxnParamSettings, CBaseLogger *pLogger );
	CCETxnMixGenerator( PDriverCETxnSettings pTxnParamSettings, RNGSEED RNGSeed, CBaseLogger *pLogger);
